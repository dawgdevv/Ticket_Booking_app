...
const ExplanationPopup = () => {
  ...
  const questions = [
    ...
    {
        question: "How do you ensure the security and privacy of users on the platform?",
        answer: "Security and privacy are top priorities. We implement industry-standard encryption for all transactions and personal data. Blockchain technology ensures transparency, while decentralized features mean there’s no central authority holding sensitive information. Users have full control over their data, and we strictly adhere to best practices for protecting user information.",
    },
    {
      question: "How is your app legal?",
      answer: "We understand your concerns regarding the resell feature. Please understand that our platform allows for authorised resales and transparent ticket transfers with event organiser clearance. Unlike illegal marketplaces, all transactions on the blockchain are verifiable, subject to event terms, and protected from price gouging. We provide a clear legal framework to ensure that everything is genuine and above board.",
    },
    {
      question: "Can I use the app without a crypto wallet?",
      answer: "Yes, you can still use the app without a crypto wallet, but it’s not recommended as you might miss out on exclusive deals and discounts.",
    },
    {
      question: "What are the rules for participating in auctions?",
      answer: "The auction rules are simple for now. Users can join and create auction rooms for golden tickets. Auction rooms last for 30 seconds, and the highest bidder wins. In the future, we plan to enhance this feature by introducing a moderator or admin role to regulate the flow of the auctions.",
    },
    {
      question: "What is the future roadmap for this app, and how do you plan to scale it?",
      answer: "Our roadmap includes integrating additional payment options beyond crypto, enhancing auction features with advanced bidding mechanisms, and collaborating with more event organizers to offer exclusive content. We also plan to create partnerships with NFT artists and businesses to expand the app's offerings and grow the user base, ensuring that the platform remains dynamic and continuously evolving.",
    },
  ]
