        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0">
              <img className="h-6 w-6 mr-3 text-red-300" src="img/tickets.png" alt="Logo" />
            </Link>
            <p className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 text-2xl font-bold">DTIX</p>
            {isLoggedIn ? (
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link to="/events" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Events
                  </Link>
                  <Link to="/marketplace" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Marketplace
                  </Link>
                  <Link to="/resell" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Resell
                  </Link>
                  <Link to="/organize-auction" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Auction
                  </Link>
                  <Link to="/auction" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Auction Rooms
                  </Link>
                  <Link
                  to="/search"
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <Link to="/login" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Login
                  </Link>
                  <Link to="/signup" className="hover:text-gray-600 px-3 py-2 rounded-md text-sm font-medium">
                    Signup
                  </Link>
                </div>
              </div>
